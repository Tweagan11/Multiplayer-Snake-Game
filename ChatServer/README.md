...
# Overview of the ChatServer Functionality
This program represents the chat server that handles the connecting and disconnecting of clients.  It stores the currently connected clients
...
- The logger was left on debug level.
