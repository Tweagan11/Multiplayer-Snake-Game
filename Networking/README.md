...
This program represents the chat server networking functionality.  It contains two classes, the Server and NetworkingConnection classes.
The server class handles the server start up and multi-threading for multiple user connections.  The NetworkingConnections class is a 
wrapper for the interactions with the network and server.
